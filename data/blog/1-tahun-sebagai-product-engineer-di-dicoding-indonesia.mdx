...
draft: false
member: true
summary: Perjalanan mencari pengalaman dengan bekerja sebagai Product Engineer di Education Tech Startup.
progress: 100
image: /static/images/article/dicoding-team.webp
---
...
<div className="grid grid-rows-2 md:grid-rows-1 grid-cols-1 gap-4 md:grid-cols-2">
  <InlinePost
    href="/quiz"
